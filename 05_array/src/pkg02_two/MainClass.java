...
public class MainClass {
  ...
  public static void method1() {
     ...
     *    2) new int[m][]  - 길이가 ?인 1차원 배열이 m개 있는 배열
     */
    ...
    // 배열 요소 (배열이름 + 대괄호 2개 + 인덱스 2개) arr, arr[0]/arr[1] <- 참조변수
  ...
  public static void method3() {
    ...
    //위의 for 2개 합치기
    for(int i = 0; i < arr.length; i++) {       // arr이 arr[0], arr[1]을 참조하기 때문에 arr.length의 값을 가질 수 있음
