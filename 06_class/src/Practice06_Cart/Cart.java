...
public class Cart {
  ...
  private int count;            //카트에 담은 물건의 개수 , count = 0 일때 product[0] 과 같이 인덱스 역할을 함
  ...
  public void addProduct(Product product) {
    ...
    // 카트가 꽉 찬 경우(담은 물건의 개수이기 때문에 카트사이즈가 아님. 카트에 담은 물건-배열의 길이)
  ...
  public void removeProduct(int idx) {
    ...
    // 배열에서 products[0] products[1] products[2] 중 products[1]을 빼고 싶은 경우 
    // products[2]가 1의 자리로 이동되고 2의 자리에는 products[2]의 값이 남아 있고 나중에 다른 값이 덮어 씌워질 수 있다.
    ...
    //products 현위치 :   [A, B, C, D, E]
    //arraycopy 후 위치 : [A, C, D, E, E]
