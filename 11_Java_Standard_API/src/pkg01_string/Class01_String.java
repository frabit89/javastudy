...
public class Class01_String {
  ...
  public static void method2() {
    ...
    System.out.println(System.identityHashCode(str1));  // 참조값 확인
    System.out.println(System.identityHashCode(str2));  // 참조값 확인
  ...
  public static void method4() {
    ...
    // equalsIgnorecase : 같은문자열이면 true 반환 (대소문자 무시한다.
  ...
  public static void method13() {
    ...
    System.out.println(str.join(".", result));
