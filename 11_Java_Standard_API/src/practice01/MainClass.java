...
//    System.out.println();
//    System.out.println(/* result.replace("-", "") */  +"_" + sdf.format(timestamp) + extName);
  ...
  public static Map<String, Object> method2(String id) {
    ...
    int age = nowDate - birth;
    */
    // 태어난 년도    
    // 성별 id.substring(id.lastIndexOf("-") + 1).charAt(0)
  ...
  public static void method4() {
    ...
    while(balance > 0) {
      ...
      count++;
      System.out.println("출금 전" + balance + "원" + "회 출금액" + money + "원, 출금 후" + (balance -= money));
    }
...
//  int count = 0;
    //    List<String> yutsList = Arrays.asList(yuts);
//    ArrayList<String> yutsArrayList = new ArrayList<>(yutsList);
//    
//    double randomvalue = Math.random() * 5;
//    String randomyut = yutsArrayList.get((int)randomvalue);
//    
//    if("도".equals(randomyut)) {
//      count += 1;
//      System.out.println("나온 패 :" + randomyut + ", 이동 회수 :" + count);
//    }
//    if("개".equals(randomyut)) {
//      count += 2;
//      System.out.println("나온 패 :" + randomyut + ", 이동 회수 :" + count);
//    }
//    if("걸".endsWith(randomyut)) {
//      count += 3;
//      System.out.println("나온 패 :" + randomyut + ", 이동 회수 :" + count);
//    }
//    if("윷".equals(randomyut)) {
//      count += 4;
//      System.out.println("나온 패 :" + randomyut + ", 이동 회수 :" + count);
//    }
//    if("모".equals(randomyut)) {
//      count += 5;
//      System.out.println("나온 패 :" + randomyut + ", 이동 회수 :" + count);
//    }
//    if(" ".equals(randomyut)) {
//      System.out.println("낙입니다");
//      System.out.println("나온 패 :" + randomyut);
//    }
