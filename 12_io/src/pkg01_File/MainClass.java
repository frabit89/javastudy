...
public class MainClass {
 ...
 public static void method1() {
   ...
   // 디렉터리 유무에 따른 생성
   if(dir.exists() == false) { // 디렉터리가 없으면 !dir.exists() 도 가능
     dir.mkdirs();
   }  else {                   // 디렉터리가 있으면
 ...
 public static void method3() {
  ...
  public static void main(String[] args) {
    practice02(new File("\\2024\\01\\22"));
  }
  ...
  public static void practice02(File dir) {
    ...
    // practice02(new File(\2024\01\22))호출 후
    // practice02(new File(\2024\01)) 호출 후
    // practice02(new File(\2024) 호출로 마무리
    ...
    // 현재 디렉터리 삭제
    System.out.println(dir.getPath() + "삭제 하였습니다.");
    dir.delete();
    
    // 상위 디렉터리를 practice02 메소드에 전달
    practice02(parent);
