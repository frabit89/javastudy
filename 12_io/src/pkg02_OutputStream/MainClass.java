...
public class MainClass {
  ...
  public static void method1() {
    ...
    try {
      ...
      try {
        // 파일 출력 스트림 닫기(종료)
        if(out != null) {     // nullpointexception 을 피하기 위해 if 삽입
          out.close();
        }
      } catch (Exception e2) {
        e2.printStackTrace();
  ...
  public static void method2() {
    ...
    try {
      ...
      System.out.println(file.length() + "바이트 크기" + file.getPath() + "파일 생성");
  ...
  public static void practice01() {
    ...
    try {
      ...
      String str1 = "동해물과 백두산이 마르고 닳도록 하느님이 보우하사 우리나라 만세\n";
      String str2 = "무궁화 삼천리 화려강산 대한사람 대한으로 우리나라 만세\n";
