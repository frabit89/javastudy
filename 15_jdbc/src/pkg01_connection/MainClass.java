...
public class MainClass {
  ...
  /*
   * oracle.jdbc.OracleDrvier
   * 1. 오라클 데이터베이스에 접속하기 위해서 필요한 드라이버 클래스이다.
   * 2. 오라클에서 만들어서 배포한다.
   * 3. 18c XE 버전의 경우 C:\app\GD\product\18.0.0\dbhomeXE\jdbc\lib\ojbc8.jar 파일을 프로젝트의 build path 에 등록해야 한다.
   */
  ...
  public static void method2() {
    ...
    String url = "jdbc:oracle:thin:@127.0.0.1:1521:xe"; // localhost는 127.0.0.1을 사용
    String user = "GD";
  ...
  public static void method4() {
    ...
    // 사용자 프로퍼티 등록 (jdbc.url, jdbc.user, jdbc.passwrod)
    // **공백을 넣으면 안 됨.
